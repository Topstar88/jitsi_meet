...
exports.getPropertyAppearance = function (property, props, definitions) {
    if (props === void 0) { props = {}; }
    if (definitions === void 0) { definitions = themeDefinitions_1.default; }
...
function getButtonStyles(props) {
    ...
    var baseSize = theme_1.fontSize(props);
    var buttonHeight = theme_1.math.divide(theme_1.math.multiply(theme_1.gridSize, 4), baseSize)(props) + "em";
    var compactButtonHeight = theme_1.math.divide(theme_1.math.multiply(theme_1.gridSize, 3), baseSize)(props) + "em";
    /**
     * Variable styles
     */
    var cursor = 'default';
    ...
    var outline = 'none';
    // $FlowFixMe - should be fixed when theme work is done
    var padding = "0 " + theme_1.gridSize(props) + "px";
     ...
     */
    var background = exports.getPropertyAppearance('background', props);
    var color = exports.getPropertyAppearance('color', props);
    var boxShadowColor = exports.getPropertyAppearance('boxShadowColor', props);
    var boxShadow = boxShadowColor
        ? styled_components_1.css(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n        box-shadow: 0 0 0 2px ", ";\n      "], ["\n        box-shadow: 0 0 0 2px ", ";\n      "])), boxShadowColor) : null;
    var textDecoration = exports.getPropertyAppearance('textDecoration', props);
    // Spacing: Compact
    ...
    return styled_components_1.css(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n    align-items: baseline;\n    background: ", ";\n    border-radius: ", "px;\n    border-width: 0;\n    box-sizing: border-box;\n    color: ", " !important;\n    cursor: ", ";\n    display: inline-flex;\n    font-size: inherit;\n    font-style: normal;\n    height: ", ";\n    line-height: ", ";\n    margin: 0;\n    max-width: 100%;\n    outline: ", " !important;\n    padding: ", ";\n    text-align: center;\n    text-decoration: ", ";\n    transition: ", ";\n    transition-duration: ", ";\n    vertical-align: ", ";\n    white-space: nowrap;\n    width: ", ";\n    ", " &::-moz-focus-inner {\n      border: 0;\n      margin: 0;\n      padding: 0;\n    }\n    ", ";\n  "], ["\n    align-items: baseline;\n    background: ", ";\n    border-radius: ", "px;\n    border-width: 0;\n    box-sizing: border-box;\n    color: ", " !important;\n    cursor: ", ";\n    display: inline-flex;\n    font-size: inherit;\n    font-style: normal;\n    height: ", ";\n    line-height: ", ";\n    margin: 0;\n    max-width: 100%;\n    outline: ", " !important;\n    padding: ", ";\n    text-align: center;\n    text-decoration: ", ";\n    transition: ", ";\n    transition-duration: ", ";\n    vertical-align: ", ";\n    white-space: nowrap;\n    width: ", ";\n    ", " &::-moz-focus-inner {\n      border: 0;\n      margin: 0;\n      padding: 0;\n    }\n    ", ";\n  "])), background, theme_1.borderRadius, color, cursor, height, lineHeight, outline, padding, textDecoration, transition, transitionDuration, verticalAlign, width, boxShadow, isLoadingStyles);
}
